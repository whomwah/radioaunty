...
- (id)initUsingBroadcastXML:(NSXMLNode *)node
{
  ...
  [self setAvailable:[self fetchDateForXPath:@"media[@format=\"audio\"]/expires" withNode:episode]];
  [self setAvailableText:[NSString stringForXPath:@"media[@format=\"audio\"]/availability" ofNode:episode]];
